...
<Note>Requires the optional `parquet` dependency group: `pip install kura[parquet]`</Note>
...
<ParamField path="compression" type="str" default="snappy">
...
<Note>Requires the optional `sqlmodel` dependency: `pip install sqlmodel`</Note>
...
<ResponseField name="create_run" type="RunTable">
  Create a new analysis run for organizing checkpoints.
...
<ResponseField name="get_run" type="Optional[RunTable]">
...
<ResponseField name="list_runs" type="List[RunTable]">
  List all analysis runs.
  
  **Returns:** List of RunTable objects ordered by creation time
</ResponseField>
